...
function logKereses(t, searchElement) {
    ...
    while (u <= v && !l) {
        ...
        valtozokKiirasa({nev: "u", ertek: u + 1}, {nev: "v", ertek: v + 1}, {
            nev: "I",
            ertek: ((u + v) / 2 | 0) + 1
        }, {nev: "L", ertek: l}, {nev: "T", ertek: t.slice(u, v + 1)}, "ciklusLepes");
        vizsgaltIndexek = [];
        for (var i = u; i <= v; i++) vizsgaltIndexek.push(i);
        tombKiirasa(t, vizsgaltIndexek, [(u + v) / 2 | 0], "");
    }
    if (l) {
        valtozokKiirasa({nev: "I", ertek: ((u + v) / 2 | 0) + 1, class: "blueElem"}, {
            nev: "l",
            ertek: l,
            class: "blueElem"
        }, "ciklusLepes");
